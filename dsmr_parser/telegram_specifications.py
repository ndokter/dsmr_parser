...
V5 = {
    ...
    'objects': {
        ...
        obis.VOLTAGE_SWELL_L2_COUNT: CosemParser(ValueParser(int)),
        obis.VOLTAGE_SWELL_L3_COUNT: CosemParser(ValueParser(int)),
        obis.INSTANTANEOUS_VOLTAGE_L1: CosemParser(ValueParser(int)),
        obis.INSTANTANEOUS_VOLTAGE_L2: CosemParser(ValueParser(int)),
        obis.INSTANTANEOUS_VOLTAGE_L3: CosemParser(ValueParser(int)),
        obis.INSTANTANEOUS_CURRENT_L1: CosemParser(ValueParser(int)),
        obis.INSTANTANEOUS_CURRENT_L2: CosemParser(ValueParser(int)),
        obis.INSTANTANEOUS_CURRENT_L3: CosemParser(ValueParser(int)),
        obis.TEXT_MESSAGE: CosemParser(ValueParser(str)),
        obis.DEVICE_TYPE: CosemParser(ValueParser(int)),
        obis.INSTANTANEOUS_ACTIVE_POWER_L1_POSITIVE: CosemParser(ValueParser(Decimal)),
        obis.INSTANTANEOUS_ACTIVE_POWER_L2_POSITIVE: CosemParser(ValueParser(Decimal)),
