...
from test.example_telegrams import TELEGRAM_V5_ESO_setP1_extended_1ph


class TelegramParserV5SetP1Extended1PhTest(unittest.TestCase):
    """ Test parsing of DSMR v5 ESO Lithuania extended P1 1ph telegram. """
    ...
    def test_parse(self):
        ...
        try:
            telegram = parser.parse(
                TELEGRAM_V5_ESO_setP1_extended_1ph,
                throw_ex=True
            )
        ...
        assert telegram.ELECTRICITY_IMPORTED_TOTAL.value == Decimal("755.487")
        ...
        assert telegram.ELECTRICITY_USED_TARIFF_1.value == Decimal("412.878")
        ...
        assert telegram.ELECTRICITY_USED_TARIFF_2.value == Decimal("342.609")
        ...
        assert telegram.ELECTRICITY_REACTIVE_IMPORTED_TOTAL.value == Decimal("9.344")
        ...
        assert telegram.ELECTRICITY_REACTIVE_EXPORTED_TOTAL.value == Decimal("280.264")
        ...
        assert telegram.INSTANTANEOUS_ACTIVE_POWER_L1_POSITIVE.value == Decimal("0.145")
        ...
        assert telegram.INSTANTANEOUS_REACTIVE_POWER_L1_NEGATIVE.value == Decimal("0.061")
        ...
        assert telegram.INSTANTANEOUS_VOLTAGE_L1.value == Decimal("223.2")
        ...
        assert telegram.ESO_LT_INSTANTANEOUS_POWER_FACTOR_TOTAL.value == Decimal("0.616")
        ...
        assert telegram.ESO_LT_INSTANTANEOUS_POWER_FACTOR_L1.value == Decimal("0.616")
        ...
        assert telegram.TEXT_MESSAGE.value == \
            "73657450315F657874656E6465645F317068"
        ...
        assert telegram.EQUIPMENT_IDENTIFIER.value == "53414731303030303030303030303032"
    ...
    def test_checksum_invalid(self):
        corrupted = TELEGRAM_V5_ESO_setP1_extended_1ph.replace(
            "1-0:1.8.1(000412.878*kWh)\r\n",
            ""
        )
